...
class InstagramBot:
    def __init__(self, username, password,mensagem):
        ...
        self.driver = webdriver.Firefox(
            executable_path=r"C:\Users\mecan\Desktop\geckodriver/geckodriver.exe"
    ...
    def type_like_a_person(sentence, single_input_field):
        ...
        print("Só vem quer eu te conto um segredo kkkkk")
...
jhonatanBot = InstagramBot(
    "jw3996528@gmail.com", "96588268", "Venha ver o inacreditavel no meu perfil..... "
